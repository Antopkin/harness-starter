...
description: >
  ...
  «lit-search». NOT: конспект своего PDF → pdf-digest; NOT: оформить ссылку → cite.
---
...
Дальше по цепочке: подробно законспектировать найденный PDF — `pdf-digest`;
оформить ссылки для списка литературы — `cite`.
...
4. **Читай отобранное** послойно: аннотация → введение и выводы → при нужде глубже.
   Глубокий конспект отдельной статьи — это уже `pdf-digest`.
...
- Что стоит прочитать глубоко (→ pdf-digest) и что оформить в список (→ cite).
