...
Таблица привязки проверена литеральным поиском цитат в исходном тексте; ссылку и
BibTeX оформил сам `digest`.
...
- DOI и страницы публикации ICLR 2023 в файле отсутствуют — сверить по первоисточнику (→ lit-search).
...
Оформлена самим digest по `references/bibtex-fields.md`. Точные страницы и DOI публикации ICLR 2023 в источнике отсутствуют — помечены `[проверить]`, не выдуманы.
