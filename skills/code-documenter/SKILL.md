...
**Output language:** the coverage report follows the language of the user's request; docstrings and other text written into existing files follow those files' language. **Length cap:** at most 400 words. **Return shape:** the coverage report template in `references/coverage-reports.md` — Summary, Coverage Before/After, Files Modified, API Documentation, Documentation Style, Next Steps. This governs every step in this section.
