...
Host-agnostic submode: resolve by the meaning of both sides, pass the tests-and-lint
gate, never force-push or bypass hooks. The steps and the submode's output contract
live in [the conflict submode](references/conflict-submode.md).
