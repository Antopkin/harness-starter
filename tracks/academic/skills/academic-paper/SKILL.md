---
name: academic-paper
description: "Academic paper writing agent team (12 agents): IMRaD, literature review, theoretical, case study, policy brief, conference paper. APA 7.0/Chicago/MLA/IEEE/Vancouver citations, bilingual abstracts, LaTeX/DOCX/PDF/Markdown output. Triggers: write/revise paper, paper outline, write abstract, check citations, parse reviews, revision roadmap. Not raw research or lit-search — that's deep-research."
metadata:
  version: "2.4"
