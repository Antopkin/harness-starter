...
Stage 5 FINALIZE: Ask format style -> MD + DOCX + LaTeX (apa7/ieee/etc.) -> xelatex -> PDF
...
**Output language:** the user's language, with academic terminology kept in English. **Length cap:** at most 300 words. **Return shape:** the Pipeline Audit Trail block above, line for line.
