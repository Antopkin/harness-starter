...
**Output language:** the language of the journal submission. **Length cap:** at most 300 words. **Return shape:** the External Review Summary block above, plus per comment the reviewer number, comment type, core request, original text quote and paper section involved.
...
**Output language:** the language of the journal submission. **Length cap:** at most 800 words in the hand-back summary; the revised draft and the letter themselves are files. **Return shape:** revised draft with tracked modification locations, plus the point-by-point Response to Reviewers block above.
