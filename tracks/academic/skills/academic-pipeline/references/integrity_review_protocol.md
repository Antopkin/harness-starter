...
**Output language:** the language of the paper. **Length cap:** at most 400 words in the verdict handed back to the orchestrator; the full report is a file. **Return shape:** the report template under `## Output Format` in `agents/integrity_verification_agent.md`.
