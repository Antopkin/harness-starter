...
**Output language:** the language of the user's request. **Length cap:** at most 300 words per hand-back. **Return shape:** stage id, mode, deliverables, handoff materials. Governs all three agents listed above.
...
**Output language:** the language of the user's request. **Length cap:** at most 200 words for the stage-completion hand-back. **Return shape:** stage id, mode used, deliverables list, completion status.
...
**Output language:** the language of the user's request. **Length cap:** at most 200 words per transition. **Return shape:** from stage, to stage, handoff materials passed, next stage's mode. Governs every transition listed above.
