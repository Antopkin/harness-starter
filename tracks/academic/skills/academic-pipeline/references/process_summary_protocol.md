...
**Output language:** the language the user chooses in step 1 (Traditional Chinese, English, or both). **Length cap:** at most 2000 words per language version. **Return shape:** the sections listed under `### Required Content in Process Record` below.
...
- **Compilation**: xelatex (same toolchain as Stage 5)
