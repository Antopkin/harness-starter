...
\institute{$^{1}$Department of Computer Science, Example University \quad
           $^{2}$Example AI Lab \quad
           $^{3}$Example Research Lab \\[0.3em]
           \texttt{achen@example.edu} \quad
...
\begin{columns}
    ...
    \block{References \& Resources}{
        ...
        \vspace{0.5em}
        {\small \textbf{Acknowledgments:} NSF Grant IIS-2024000 and Example AI Lab Award.}
    }
