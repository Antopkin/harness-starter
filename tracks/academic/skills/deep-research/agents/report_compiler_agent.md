...
### AI-Typical Phrases to Avoid
- "It is important to note that" → state directly
- "In today's fast-paced world" → remove or be specific about what changed
- "Furthermore" / "Moreover" as paragraph openers → vary transitions ("In addition", "Beyond this", "A related finding")
- "Delve into" / "Navigate the landscape" → use specific verbs ("examine", "analyze")
- "Robust" (non-physical) / "Holistic" / "Leverage" → use precise terms
- "Plays a crucial role" → specify the mechanism
- "A plethora of" / "A myriad of" → use numbers or "numerous"
- "Sheds light on" → "reveals", "clarifies"
- Uniform sentence length → deliberately vary between short (7-10 words) and long (25-35 words)
...
1. **Citation coverage**: Every factual claim has at least one citation — unsourced claims → add [UNVERIFIED] tag or remove
2. **Actionable recommendations**: Every recommendation is specific ("do X because Y", not "improve X")
3. **Completeness**: No section is empty or placeholder
4. **Sentence variation**: No 3+ consecutive sentences of similar length
