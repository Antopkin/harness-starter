...
**Verification Basis:** According to MOE announcements and the implementation status of the "Private Senior High School and Above Exit Act," as of early 2025, institutions that have completed enrollment suspension or closure procedures include: (synthetic names) Institution A (closed 2014), Institution B (enrollment suspended 2014, closed 2021), Institution C (enrollment suspended 2018), Institution D (enrollment suspended 2019), Institution E (enrollment suspended 2020), Institution F (enrollment suspended 2020), Institution G (closed 2022), Institution H (enrollment suspended 2022), Institution I (enrollment suspended 2023), Institution J (enrollment suspended 2023), Institution K (enrollment suspended 2023), Institution L (closed 2023), Institution M (enrollment suspended 2024), Institution N (enrollment suspended 2024), among others. The total exceeds 10 institutions; this claim is verified.
